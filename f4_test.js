...
async function $_f4_$(){                      // 1:
  var $_f4_q_$ = Promise.resolve (8);         // 2: MOD = { $_f4_q_$ }, REF = { Promise }
  var $_f4_z_$ = await $_f4_p_$();            // 3: MOD = { $_f4_z_$ }, REF = { $_f4_p_$, Promise }
  var $_f4_r_$ = Promise.resolve ($_f4_q_$);  // 4: MOD = { $_f4_r_$ }, REF = { $_f4_q_$, Promise }
}
