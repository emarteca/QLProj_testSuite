...
async function $_f3_$(){                      // 1:
  var $_f3_q_$ = Promise.resolve (8);         // 2: MOD = { $_f3_q_$ }, REF = { Promise }
  var $_f3_z_$ = await $_f3_p_$();            // 3: MOD = { $_f3_z_$ }, REF = { $_f3_p_$, Promise }
  var $_f3_r_$ = Promise.resolve (8);         // 4: MOD = { $_f3_r_$ }, REF = { Promise }
}
