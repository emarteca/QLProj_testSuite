...
async function $_f8_$(){                      // 1:
  var $_f8_q_$ = Promise.resolve (8);         // 2: MOD = { $_f8_q_$ }, REF = { Promise }
  console.log($_f8_q_$);                      // 3: MOD = { }, REF = { $_f8_q_$ }  // should "console" also be in the REF set?
  var $_f8_z_$ = await $_f8_p_$();            // 4: MOD = { $_f8_z_$ }, REF = { $_f8_p_$, console }
  var $_f8_r_$ = Promise.resolve (8);         // 5: MOD = { $_f8_r_$ }, REF = { Promise }
}
